...
<%--    <link rel="stylesheet" href="/Kz.layedit-feature/Content/layui/layui/css/layui.css" />--%>
<%--    <script src="/Kz.layedit-feature/Content/layui/layui/layui.js"></script>--%>
<%--    <script src="/Kz.layedit-feature/Content/layeditor/ace/ace.js"></script>--%>
...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-footer">
        <!-- 底部固定区域 -->
        © <a href="http://www.zwblog.com">ZW博客</a> 2023  欢迎加入开发者交流群 待创建，博主免费回答大家日常问题。共勉，详情参看 <a href="https://github.com/zhenghejie" target="_blank">共勉</a>
    </div>
</div>
