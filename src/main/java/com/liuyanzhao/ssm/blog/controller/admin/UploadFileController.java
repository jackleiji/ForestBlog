...
public class UploadFileController {
     ...
     * 文件保存目录，物理路径
     */
    public final String rootPath = "/media/uploads";
//    public final String rootPath = "D:\\uploads";

    public final String allowSuffix = ".bmp.jpg.jpeg.png.gif.pdf.doc.zip.rar.gz";

    @RequestMapping(value = "/imgTinyMCE", method = RequestMethod.POST)
    public JsonResult uploadFileTinyMCE(@RequestParam("edit") MultipartFile file) {
        //1.文件后缀过滤，只允许部分后缀
